...
import { handleGetLocations, handlePostLocation, handleSearchLocations } from "../../server/routes/locations";
import { handleRouteRequest } from "../../server/routes/navigation";
import {
  getTimetable,
  addCourse,
  deleteCourse,
...
import {
  ...
  updateErrorReport,
  deleteErrorReport
} from "../../server/routes/error-reports";
import {
  trackPageView,
  trackPageExit,
  trackNavigation,
...
import { getGuidance } from "../../server/routes/guidance";
import {
  handleGetShortcuts,
  handleReportShortcut,
  handleVerifyShortcut,
  handleGetShortcutsBetween
} from "../../server/routes/shortcuts";
import {
...
import {
  ...
  handleGetHighlights,
  handleLogTourView
} from "../../server/routes/virtual-tour";
